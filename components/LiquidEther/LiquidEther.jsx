  ...
  useEffect(() => {
    ...
    class CommonClass {
      ...
      init(container) {
        ...
        // Capped at 1.5 (not 2) and antialias off: this is a soft, out-of-focus
        // fluid background with no hard edges to alias, so the extra fragment
        // work at 2x DPR bought nothing visible while costing ~4x the fill rate
        // of 1x on a HiDPI screen — the single largest GPU cost on the page.
